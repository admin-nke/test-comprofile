...
<html class="no-js" lang="zxx">
    ...
    <head>
        ...
        <title>Forgex - Contact Page </title>
    ...
    <body >
                        ...
                        <ul id="main-nav" class="nav navbar-nav clearfix">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu clearfix">
                                    ...
                                    <li>
                                        <a href="index-6.html">Engineering</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu clearfix">
                                    <li>
                                        <a href="projects-1.html">projects one</a>
                                    </li>
                                    <li>
                                        <a href="projects-2.html">projects  two</a>
                                    </li>
                                    <li>
                                        <a href="projects-3.html">projects  three</a>
                                    </li>
                                    <li>
                                        <a href="projects-4.html">projects  four</a>
                                    </li>
                                    <li>
            ...
            <div class="container fx-container-1">
                <div class="breadcrumb-wrap">
                    ...
                    <div class="breadcrumb-content">
                        ...
                        <h1 class="breadcrumb-title fx-heading-1 text-uppercase " data-txaa-split-text-1 >Discover Us Through Our Updated Contact Methods.</h1>

                        <p class="breadcrumb-disc fx-para-1 has-clr-white fix"><span class="d-inline-block breadcrumb-slideup">Stay connected with us through our newly updated contact methods. Experience faster, more efficient</span></p>

                        <div class="breadcrumb-btn fix">
                            <span class="d-inline-block breadcrumb-slideup">
                                <a href="#has-jump" aria-label="name" class="fx-pr-btn-1 has-hover-white">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="fx-contact-us-1-left">
                            ...
                            <form action="#" class="fx-form-1" id="form-contact">

                                <!-- single-box -->
                                <div class="fx-form-1-box">
                                    <label class="fx-form-1-label" >full name:</label>
                                    <input class="fx-form-1-input" type="text" placeholder="e.g. Oliver Spiteri">
                                </div>

                                <!-- single-box -->
                                <div class="fx-form-1-box">
                                    <label class="fx-form-1-label" >company:</label>
                                    <input class="fx-form-1-input" type="text" placeholder="e.g. ForgeX LLC">
                                </div>

                                <!-- single-box -->
                                <div class="fx-form-1-box">
                                    <label class="fx-form-1-label" >phone:</label>
                                    <input class="fx-form-1-input" type="tel" placeholder="+44 20 8980 9731">
                                </div>

                                <!-- single-box -->
                                <div class="fx-form-1-box">
                                    <label class="fx-form-1-label" >Email:</label>
                                    <input class="fx-form-1-input" type="email" placeholder="info@forgexindustry.co.uk">
                                </div>

                                <!-- single-box -->
                                <div class="fx-form-1-box">
                                    <label class="fx-form-1-label" >address:</label>
                                    <input class="fx-form-1-input" type="text" placeholder="e.g. ThemeXriver LLC.">
                                </div>

                                <!-- single-box -->
                                <div class="fx-form-1-box">
                                    <label class="fx-form-1-label" >message:</label>
                                    <textarea class="fx-form-1-input" placeholder="Write your message here..."></textarea>
                                </div>
                            ...
                            <div class="fx-contact-us-1-content fix">
                                <div class="fx-contact-us-1-info-box fix txxaslideup">
                                    ...
                                    <p class="address fx-para-1 has-clr-white">
                                        <span class="txxaslideup-item fx-cube-1">31 St Martin's Ln, London WC2N 4DD United Kingdom</span>
                                    </p>
                                </div>
        ...
        <!--cta-start -->
        <div class="fx-cta-1-area pt-55 pb-55 p-relative fix ">
            <div class="fx-cta-1-bg-img fix img-cover">
                <img src="assets/img/cta/cta-img-1.png" alt="">
            </div>
            <div class="container fx-container-1">
                <div class="fx-cta-1-content">
                    <h3 class="fx-cta-1-content-title fx-heading-1 has-clr-white fx-font-600 txaa-split-text-3 txaa-split-text-3-ani">Boost Engagement with Our Exclusive Newsletter Subscription Today!</h3>

                    <form action="#" class="fx-cta-1-form">
                        <input type="text" placeholder="Write your mail here..." class="fx-cta-1-form-input">
                        <button type="button" aria-label="name" class="fx-cta-1-form-btn">
                            submit
                ...
                <div class="fx-footer-1-widget pt-120 pb-95">
                    ...
                    <div class="fx-footer-1-widget-single">
                        ...
                        <ul class="fx-footer-1-menu">
                            ...
                            <li class="dropdown">
                                <a  class="dropdown-link" href="!#">pages</a>
                                <ul class="has-dropdown">
                                    <li>
                            ...
                            <li class="dropdown">
                                <a class="dropdown-link" href="!#">Elements</a>
                                <ul class="has-dropdown">
                                    <li>
                                        <a  href="#">Elements 1</a>
                                    </li>
                            ...
                            <li class="dropdown">
                                <a class="dropdown-link" href="!#">news</a>
                                <ul class="has-dropdown">
                                    <li>
                                        <a  href="#">news 1</a>
                                    </li>
                    ...
                    <!-- single-widget -->
                    <div class="fx-footer-1-widget-single">
                        <h6 class="widget-title fx-heading-1 ">Our Services:</h6>

                        <ul class="fx-footer-1-menu-2">
                            <li>
                                <a href="#" aria-label="name">Industrial Manufacturing</a>
                            </li>
                            <li>
                                <a href="#" aria-label="name">Engineering</a>
                            </li>
                            <li>
                                <a href="#" aria-label="name">Construction</a>
                            </li>
                            <li>
                                <a href="#" aria-label="name">Building maintenance</a>
                            </li>
                            <li>
                                <a href="#" aria-label="name">Shipping</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="fx-footer-1-widget-single">
                        ...
                        <ul class="fx-footer-1-contact">
                            <li>
                                ...
                                31 St Martin's Ln, <br> London WC2N 4DD, United Kingdom
                            </li>
                            <li>
                                <a href="#" aria-label="name">
                                    <i class="fa-regular fa-envelope"></i>
            ...
            <div class="fx-marquee-text-1 fix pt-55 pb-55">
                <div class="js-marquee-wrapper">
                    <div class="fx-marquee-text-1-item">
                        ...
                        <h2 class="fx-heading-1 fx-font-600 text-uppercase item-text">through ingenuity</h2>
            ...
            <div class="fx-footer-1-copyright pt-40 pb-40">
                <div class="container fx-container-1">
                    <div class="fx-footer-1-copyright-flex d-flex align-items-center">
                        <p class="fx-footer-1-copyright-text fx-para-1">©2024, <a href="index.html" aria-label="name">ForgeX Industrial Service Solutions.</a> All Rights Reserved.</p>
